"""
schedulo/ai_agents/orchestrator.py
ChronoOrchestrator — LangGraph StateGraph DAG that wires all 6 Schedulo
...
class ChronoOrchestrator:
    """
    LangGraph-based pipeline orchestrator for Schedulo.
    ...
    async def run(
        ...
        semester: str | None = None,      # BUG 6 FIX: thread semester through pipeline
        ...
        initial_state: State = {
            ...
            "semester":      semester,     # BUG 6 FIX: included in state
