"""
schedulo/ai_agents/chatbot_modification_agent.py
ChatbotModificationAgent — LangGraph node that applies validated
timetable modifications requested through ScheduloBot.
...
class ChatbotModificationAgent:
    """
    LangGraph node that applies ScheduloBot-requested timetable mutations
