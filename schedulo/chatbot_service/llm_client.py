"""
schedulo/chatbot_service/llm_client.py — ScheduloBotLLMClient
Wrapper around Hugging Face InferenceClient for ScheduloBot.
...
class ScheduloBotLLMClient:
    """
    HuggingFace InferenceClient wrapper for ScheduloBot.
    ...
    def __init__(self, token_override: str | None = None) -> None:
        ...
        self.token = token_override or settings.hf_api_token
...
# ── System prompt for ScheduloBot ───────────────────────────────────
SYSTEM_PROMPT_TEMPLATE = """You are ScheduloBot, an expert university scheduling assistant embedded within the Schedulo timetable management system. You help faculty members view, understand, and modify their timetables and the timetables of sections they teach.
...
def build_system_prompt(
    ...
    """Render the ScheduloBot system prompt with current context values."""
