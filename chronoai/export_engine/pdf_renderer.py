"""
chronoai/export_engine/pdf_renderer.py
ReportLab PDF renderer for ChronoAI timetables.
...
class PDFRenderer:
    """
    Renders ChronoAI section timetables to a multi-page A3 PDF.
    ...
    async def render_from_db(
        ...
        from chronoai.models import TimetableSlot, Section, Timetable
    ...
    def _render_section_page(
        ...
        canv.setFont("Helvetica", 7)
        canv.drawString(MARGIN, MARGIN, f"Generated by ChronoAI  •  {now_str}")
        canv.drawRightString(page_w - MARGIN, MARGIN, "ChronoAI — Intelligent University Scheduling")
